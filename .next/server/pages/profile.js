...
/* harmony import */ var _styles_module_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(3186);
...
function Profile({
  ...
  const quickCheck = async () => {
    if (textData === '{}') {
      ...
      class UserData extends (react__WEBPACK_IMPORTED_MODULE_4___default().Component) {
        render() {
          return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", {
              children: ["Username: ", data.username.toString()]
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", {
              children: ["Email: ", data.email.toString()]
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", {
              children: ["User Id: ", data.id.toString()]
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", {
              children: ["Date Created: ", data.dateCreated.toString()]
            })]
          });
        }
      ...
      react_dom__WEBPACK_IMPORTED_MODULE_5___default().render( /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(UserData, {}), document.getElementById('userData'));
    }
  };
  ...
  const handleSubmit = async () => {
    if (confirm('Are you sure you want to logout?')) {
      ...
      if (statusJson.status !== 'ok') {
        class LogoutTag extends (react__WEBPACK_IMPORTED_MODULE_4___default().Component) {
          render() {
            return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("h2", {
              style: {
                color: 'red'
              },
              children: ["An error has occured! ", statusJson.status]
            });
          }

        }

        react_dom__WEBPACK_IMPORTED_MODULE_5___default().render( /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(LogoutTag, {}), document.getElementById('logoutStatus'));
        ...
        class LogoutTag extends (react__WEBPACK_IMPORTED_MODULE_4___default().Component) {
          render() {
            return /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h2", {
              ...
              children: "Logged out! Redirecting..."
            });
          }
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((styled_jsx_style__WEBPACK_IMPORTED_MODULE_1___default()), {
      ...
      className: "jsx-1876354582" + " " + ((_styles_module_css__WEBPACK_IMPORTED_MODULE_9___default().maindiv) || ""),
...
var __webpack_exports__ = __webpack_require__.X(0, [664], function() { return __webpack_exec__(3245); });
