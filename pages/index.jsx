...
function Home({ textData, jsonData }) {
    ...
    `}</style>
                ...
                <div className="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
                    <ul className="navbar-nav mr-auto">
                        <li className="nav-item active">
                            <Link href="./"><a className="nav-link active"><FontAwesomeIcon icon={faHome} /> Home</a></Link>
                        </li>
            ...
            <div className={styles.maindiv}>
                <h1 style={{ fontSize: 72, marginTop: 15 }}>Phoenix Servers Minecraft</h1>
                <p>Welcome to the Phoneix Servers Wesbite</p>
            </div>
        </div>
    )
}
